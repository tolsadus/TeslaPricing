...
const en = {
  ...
  card_new: "New",
  card_ad_sponsored: "Sponsored",
  card_ad_placeholder: "Advertisement",
  chip_seats: "seats",
  // States
  loading: "Loading…",
  ...
  sign_in: "Sign in",
  sign_out: "Sign out",
  get_extension: "Chrome extension",
  ...
  pin_listing: "Pin to top",
  unpin_listing: "Unpin",
  hidden_show_count: "Show {n} hidden",
  hidden_hide_count: "Hide {n} hidden",
  hidden_clear: "Clear hidden",
  hidden_clear_confirm: "Reset {n} hidden listing(s)?",
...
const fr: Record<TKey, string> = {
  ...
  card_new: "Neuf",
  card_ad_sponsored: "Sponsorisé",
  card_ad_placeholder: "Publicité",
  chip_seats: "places",
  // States
  loading: "Chargement…",
  ...
  get_extension: "Extension Chrome",
  ...
  pin_listing: "Épingler en haut",
  unpin_listing: "Désépingler",
  hidden_show_count: "Afficher {n} masquée(s)",
  hidden_hide_count: "Cacher {n} masquée(s)",
  hidden_clear: "Effacer masqués",
  hidden_clear_confirm: "Réinitialiser {n} annonce(s) masquée(s) ?",
